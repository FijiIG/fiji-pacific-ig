# Pacific Patient - Fiji Pacific Core Implementation Guide v0.2.1
...
* Refer to this Profile: [Pacific Allergy/Intolerance](StructureDefinition-pacific-allergy-intolerance.md), [Pacific Condition](StructureDefinition-pacific-condition.md), [Pacific Immunization](StructureDefinition-pacific-immunization.md) and [Pacific Observation](StructureDefinition-pacific-observation.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.uv.pacific.core|current/StructureDefinition/StructureDefinition-pacific-patient.json)
...
```json
{
  ...
  "id" : "pacific-patient",
  "url" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-patient",
  "version" : "0.2.1",
  "name" : "PacificPatient",
  ...
  "description" : "Patient profile for South Pacific jurisdictions.\n\nIntegrates:\n- PacificHumanName\n- Patient-level clan affiliation\n- Guidance for usual vs official name use",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-clan-affiliation"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "HumanName",
        "profile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-humanname"]
      }]
    },
    {
      "id" : "Patient.gender",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Address",
        "profile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-address"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-practitioner",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-practitioner-role",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-organization",
