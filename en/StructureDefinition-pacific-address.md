# Pacific Address - Fiji Pacific Core Implementation Guide v0.2.1
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.uv.pacific.core|current/StructureDefinition/StructureDefinition-pacific-address.json)
...
```json
{
  ...
  "id" : "pacific-address",
  "url" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-address",
  "version" : "0.2.1",
  "name" : "PacificAddress",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-address-village"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-address-island"]
      }],
      "mustSupport" : true
    },
    {
