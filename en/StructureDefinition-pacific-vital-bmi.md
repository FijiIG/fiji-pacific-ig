# BMI Vitals (Pacific region) - Fiji Pacific Core Implementation Guide v0.2.1
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.uv.pacific.core|current/StructureDefinition/StructureDefinition-pacific-vital-bmi.json)
...
```json
{
  ...
  "url" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-vital-bmi",
  "version" : "0.2.1",
  "name" : "PacificBMI",
