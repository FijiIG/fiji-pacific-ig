# Heart Rate Vitals (Pacific region) - Fiji Pacific Core Implementation Guide v0.2.1
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.uv.pacific.core|current/StructureDefinition/StructureDefinition-pacific-vital-heart-rate.json)
...
```json
{
  ...
  "url" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-vital-heart-rate",
  "version" : "0.2.1",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-observation",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://fijiig.github.io/fiji-pacific-ig/ValueSet/heart-rate-loinc"
      }
    },
    {
