# Resource Fiji Pacific Core Implementation Guide
...
```json
{
  ...
  "id" : "hl7.fhir.uv.pacific.core",
  "language" : "en",
  "url" : "https://fijiig.github.io/fiji-pacific-ig/ImplementationGuide/hl7.fhir.uv.pacific.core",
  "version" : "0.2.1",
  "name" : "FijiPacificCore",
  "title" : "Fiji Pacific Core Implementation Guide",
  "status" : "draft",
  ...
  "description" : "Implementation Guide for Fiji FHIR Interopeerability with base definitions applicable to the wider South Pacific region.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "hl7.fhir.uv.pacific.core",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fijiig.github.io/fiji-pacific-ig/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "exampleCanonical" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-immunization"
      },
      "name" : "Pacific Immunization",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-practitioner"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://fijiig.github.io/fiji-pacific-ig/StructureDefinition/pacific-practitioner-role"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/WSPractitionerRegistration"
      },
      "name" : "Western Samoa Practitioner Registration",
    ...
    "page" : {
      ...
      },
      {
        ...
        "title" : "Contributing to the Fiji/Pacific Core IG",
        "generation" : "markdown"
      },
      {
        "extension" : [{
